...
def main(page: ft.Page):
    ...
    entry_tarih = ft.TextField(label="Tarih (YY/AA/GG)", value="24/11/25", keyboard_type=ft.KeyboardType.DATETIME)
    entry_saat = ft.TextField(label="Başlangıç Saati (SS:DD)", value="10:00", keyboard_type=ft.KeyboardType.DATETIME)
...
"""
            ...
            # APK'da (Android'de) İndirilenler Klasörüne Kaydetme Ayarı
            ...
            show_snack(f"Hata oluştu. Lütfen değerleri kontrol edin.", color=ft.colors.RED_700)
